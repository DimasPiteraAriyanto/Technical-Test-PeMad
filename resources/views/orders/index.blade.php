        ...
        <div class="page-header-content pt-4">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-auto my-4">
                    <a href="{{ route('orders.create') }}" class="btn btn-primary add-list"><i class="fa-solid fa-plus me-3"></i>Add</a>
                    <a href="{{ route('orders.index') }}" class="btn btn-danger add-list"><i class="fa-solid fa-trash me-3"></i>Clear Search</a>
                </div>
            </div>
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">             <form action="{{ route('orders.destroy', $order->id) }}" method="POST">
                                                @csrf
                                                @method('delete')
                                ...
                                <tr class="accordion-content" id="accordion-{{ $order->id }}" style="display: none;">
                                    <td colspan="4">
                                                    ...
                                                    <div class="card-body">
                                                        <ul>
                                                            @foreach ($order->purchaseOrders as $purchaseOrder)
                                                                <li>{{ $purchaseOrder->total_purchase_order }}</li>
                                                            @endforeach
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapse{{ $order->id }}" class="accordion-collapse collapse" aria-labelledby="heading{{ $order->id }}" data-bs-parent="#accordion-{{ $order->id }}">
                                                    <div class="accordion-body">
                                                        <ul>
                                                            @foreach ($order->purchaseOrders as $purchaseOrder)
                                                                <li>{{ $purchaseOrder->name_order }}</li>
                                                            @endforeach
                                                        </ul>
                                                    </div>
                                                </div>

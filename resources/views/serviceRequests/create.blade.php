        ...
        <div class="page-header-content pt-4">
            ...
            <nav class="mt-4 rounded" aria-label="breadcrumb">
                <ol class="breadcrumb px-3 py-2 rounded mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('serviceRequests.index') }}">Service Requests</a></li>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-solid @error('name_service_request') is-invalid @enderror" id="name_service_request" name="name_service_request" type="text" value="{{ old('name_service_request') }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-solid @error('start_date_service_request') is-invalid @enderror" id="start_date_service_request" name="start_date_service_request" type="date" value="{{ old('start_date_service_request') }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-solid @error('end_date_service_request') is-invalid @enderror" id="end_date_service_request" name="end_date_service_request" type="date" value="{{ old('end_date_service_request') }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-solid @error('price_service_request') is-invalid @enderror" id="price_service_request" name="price_service_request" type="number" value="{{ old('price_service_request') }}" />
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control form-control-solid @error('detail_service_request') is-invalid @enderror" id="detail_service_request" name="detail_service_request" rows="4">{{ old('detail_service_request') }}</textarea>
